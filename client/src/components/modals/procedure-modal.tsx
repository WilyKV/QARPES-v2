...
<table style="border-collapse: collapse; width: 100%; margin: 10px 0;">
 ...
 className="resize-none bg-gradient-to-r from-gray-50 to-blue-50"
 rows={2}
 {...field}
 />
 </FormControl>
 ...
 className="relative min-h-[300px] p-3 border rounded-md bg-white prose prose-sm max-w-none focus:outline-none"
