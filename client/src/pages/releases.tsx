...
function EditableCell({ value, onSave, type = "text", options = [], className = "" }: EditableCellProps) {
 ...
 autoFocus
 className="px-2 py-1 border border-blue-500 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
 >
 ...
 onKeyDown={handleKeyDown}
 autoFocus
 className="px-2 py-1 border border-blue-500 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white min-w-[150px]"
 />
 )}
 </span>
 );
...
export default function Releases() {
 ...
 <p className="mt-2 text-gray-600">Chargement des releases...</p>
 </div>
 </div>
 );
 }
 ...
 <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 shadow-lg border border-purple-200">
 ...
 <tr>
 <th className="px-4 py-3 text-left font-semibold text-gray-900 text-sm">Release</th>
 <th className="px-4 py-3 text-left font-semibold text-gray-900 text-sm">Statut</th>
 <th className="px-4 py-3 text-left font-semibold text-gray-900 text-sm">Production</th>
 <th className="px-4 py-3 text-left font-semibold text-gray-900 text-sm">Actions</th>
 </tr>
 </thead>
 ...
 return (
 <tr key={rowId} className="hover:bg-blue-50 transition-colors duration-150">
 ...
 />
 <span className="text-xs text-gray-500 mt-1">Version: {releaseId || "Non définie"}</span>
 </div>
 </td>
 ...
 <Button variant="ghost" size="sm" onClick={() => handleViewRelease(rowId!)} className="h-8 w-8 p-0 hover:bg-blue-100">
 <Eye className="h-4 w-4 text-blue-600" />
 </Button>
 <Button variant="ghost" size="sm" onClick={() => handleEdit(row)} className="h-8 w-8 p-0 hover:bg-yellow-100">
 <Edit className="h-4 w-4 text-yellow-600" />
 </Button>
 <Button variant="ghost" size="sm" onClick={() => handleDelete(rowId!)} disabled={deleteMutation.isPending} className="h-8 w-8 p-0 hover:bg-red-100">
 ...
 <th className="px-4 py-3 text-left font-semibold text-gray-900 text-sm">Release</th>
 <th className="px-4 py-3 text-left font-semibold text-gray-900 text-sm">Statut</th>
 <th className="px-4 py-3 text-left font-semibold text-gray-900 text-sm">Recette</th>
 <th className="px-4 py-3 text-left font-semibold text-gray-900 text-sm">Préprod</th>
 <th className="px-4 py-3 text-left font-semibold text-gray-900 text-sm">Production</th>
 <th className="px-4 py-3 text-left font-semibold text-gray-900 text-sm">Actions</th>
 </tr>
 </thead>
 ...
 return (
 <tr key={rowId} className="hover:bg-amber-50 transition-colors duration-150">
 ...
 <td className="px-4 py-3">
 <div className="flex gap-1">
 <Button variant="ghost" size="sm" onClick={() => handleViewRelease(rowId!)} className="h-8 w-8 p-0 hover:bg-amber-100">
 ...
 {/* Tableau 3 : Autres */}
 <div className="bg-gradient-to-r from-slate-50 to-gray-50 rounded-xl p-6 shadow-lg border border-slate-200">
 ...
 return (
 <tr key={rowId} className="hover:bg-slate-50 transition-colors duration-150">
 ...
 <td className="px-4 py-3">
 <div className="flex gap-1">
 <Button variant="ghost" size="sm" onClick={() => handleViewRelease(rowId!)} className="h-8 w-8 p-0 hover:bg-slate-100">
