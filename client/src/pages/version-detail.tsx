...
const procedureTypeButtonColors: Record<string, string> = {
 environment_variables: "bg-emerald-50 hover:bg-emerald-100 border-emerald-200 text-emerald-700",
 service_verification: "bg-sky-50 hover:bg-sky-100 border-sky-200 text-sky-700",
 command_execution: "bg-violet-50 hover:bg-violet-100 border-violet-200 text-violet-700",
 data_import: "bg-amber-50 hover:bg-amber-100 border-amber-200 text-amber-700",
};
...
function ProcedureCard({ procedure, repoName, onEdit }: { 
 ...
 <div className="flex items-center gap-2 mb-3 pl-3 border-l-4 border-blue-400">
...
function GitRepoSection({ versionGitRepo, onAddProcedure, onEditProcedure }: { 
 ...
 return (
 <Card className="border-0 shadow-lg bg-gradient-to-r from-white to-gray-50/50 hover:shadow-xl transition-all duration-200">
 ...
 <Button variant="outline" size="sm" asChild className="hover:bg-green-50 hover:border-green-200">
...
export default function VersionDetail() {
 ...
 <div>
 <p className="text-sm font-medium text-gray-700">Repositories</p>
 <p className="text-sm text-gray-600">
 ...
 <div>
 <p className="text-sm font-medium text-gray-700">Release</p>
 <p className="text-sm text-gray-600">
 ...
 <TabsList className="grid grid-cols-4 w-full max-w-2xl bg-white/50 border border-gray-200">
 ...
 <div className="relative z-10 w-full max-w-xl bg-white border border-gray-200 rounded-lg shadow-xl p-4">
 ...
 <div>
 <textarea
 className="w-full h-40 text-sm border rounded p-2 bg-white"
 value={noteValue}
